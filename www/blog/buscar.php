				...
				<div class="section">
					<?php
						while($r = mysqli_fetch_array($q)){
							...
							echo "</div>\n";
							echo "<h2 class='post_search_title'><a itemprop='url' href='http://$http_host/blog/$r[permalink]'>$r[title]</a></h2>\n";
							...
							if (mysqli_num_rows($q_image) > 0){
								...
								echo "<img class='post_search_image alt='$r[title]' src='http://$http_host/img/blog/preview/$r_image[image]'/>\n";
								echo "</a>\n";
							}
							echo "<p class='post_search_text'>" . cutText($r['text'], 150, $lng['blog_read_more'], "http://$http_host/blog/$r[permalink]/") . "</p>\n";
							echo "<br/>\n";
							echo "</div>\n";
						}
					?>
