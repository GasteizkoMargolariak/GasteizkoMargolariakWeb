<?php
	...
	$lng['section_activities'] = 'Actividades';
	$lng['section_lablanca'] = 'La Blanca';
	$lng['section_us'] = 'Quienes somos';
	$lng['section_gallery'] = 'Galer&iacute;a';
	...
	$lng['index_upcoming_activity'] = 'Pr&oacute;xima actividad';
	$lng['index_upcoming_activity_see'] = 'Ver detalles';
	$lng['index_upcoming_activity_see_all'] = 'Todas las actividades';
	$lng['index_upcoming_activity_price'] = 'Precio: ';
	$lng['index_upcoming_activity_free'] = 'Gratuita';
	$lng['index_upcoming_activity_inscription'] = 'Inscripci&oacute;n: ';
	$lng['index_upcoming_activity_max_people'] = 'Plazas: ';
	$lng['index_upcoming_activity_date'] = 'Fecha: ';
	$lng['index_latest_posts'] = '&Uacute;ltimas entradas del blog';
	$lng['index_latest_photos'] = 'Fotos recientes';
	$lng['index_latest_activities'] = '&Uacute;ltimas actividades';
	$lng['index_no_post'] = 'No hay entradas en el blog.';
	$lng['index_see_all_posts'] = 'Ir al blog';
	...
	$lng['header_activities'] = 'Actividades';
	$lng['header_blog'] = 'Blog';
	$lng['header_whoarewe'] = 'Quienes somos';
	...
	$lng['activities_where'] = 'D&oacute;nde';
	$lng['activities_'] = '';
	...
	$lng['blog_read_more'] = 'Continuar leyendo';
	$lng['blog_'] = '';
	
	// /blog/post.php
	$lng['blog_share'] = 'Compartir:';
	$lng['blog_comments_0'] = 'A&uacute;n no hay ningun comentario';
	$lng['blog_comments_1'] = 'comentario';
	$lng['blog_comments_multiple'] = 'comentarios';
	$lng['blog_placeholder_name'] = 'Tu nombre...';
	$lng['blog_placeholder_text'] = 'Tu comentario...';
	$lng['blog_send'] = 'Enviar';
	$lng['blog_comments_closed'] = 'Este post no admite comentarios';
	$lng['blog_'] = '';
	
	// /blog/buscar.php
	$lng['blog_search_1'] = 'Buscando ';
	$lng['blog_search_2'] = ' en ';
	$lng['blog_search_result'] = ' resultado.';
	$lng['blog_search_results'] = ' resultados.';
	...
	// /galeria/album.php
	$lng['gallery_comment_count_0'] = "A&uacute;n no hay ning&uacute;n comentario.";
	$lng['gallery_comment_count_1'] = "Un comentario ";
	$lng['gallery_comment_count_several'] = " comentarios";
	$lng['gallery_new_comment'] = 'Deja un comentraio';
	$lng['gallery_new_comment_content'] = 'Texto...';
	$lng['gallery_new_comment_user'] = 'Tu nombre...';
	$lng['gallery_new_comment_submit'] = 'Enviar';
	$lng['gallery_'] = '';
	...
	$lng['error_code'] = 'CODE';
	$lng['error_404_title'] = 'No encontrado';
	$lng['error_404_description'] = 'La p&aacute;gina que buscas no existe en este universo. Int&eacute;ntalo en uno diferente.';
	$lng['error_404_solution'] = 'Prueba una soluci&oacute;n:';
