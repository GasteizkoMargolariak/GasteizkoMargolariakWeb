<?php
	...
	$lng['help_contact_register'] = 'Errolda zk.:';
	$lng['help_contact_register_value'] = 'AS/A/17445/2013';
	$lng['help_contact_date_constitution'] = 'Fundazio data:';
	$lng['help_contact_date_constitution_value'] = '18/02/2013';
	$lng['help_contact_date_inscription'] = 'Izen ematea data:';
	$lng['help_contact_date_inscription_value'] = '10/04/2013';
	$lng['help_contact_city'] = 'Udalherriko:';
	$lng['help_contact_city_value'] = 'Vitoria-Gasteiz';
	$lng['help_contact_territory'] = 'Lurralde:';
	$lng['help_contact_territory_value'] = '&Aacute;rava';
	$lng['help_contact_country'] = 'Herrialde:';
	$lng['help_contact_country_value'] = 'Espaina';
	$lng['help_contact_clasification'] = 'Sailkapena:';
	$lng['help_contact_clasification_value'] = 'Cultura General';
	$lng['help_contact_objectives'] = 'Helburua:';
	...
	$lng['help_contact_phone'] = 'Telefonoa:';
	...
	$lng['help_license_title'] = 'Lizentzia';
