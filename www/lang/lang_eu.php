<?php
    ...
    $lng['yes'] = 'Bai';
    $lng['no'] = 'Ez';
    $lng['months'] = ['Urtarrila', 'Otsaila', 'Martxoa', 'Apirila', 'Maiatza', 'Ekaina', 'Uztaila', 'Abuztua', 'Iraila', 'Urria', 'Azaroa', 'Abendua'];
    $lng['weekdays'] = ['Astelehena', 'Asteartea', 'Asteazkena', 'Osteguna', 'Ostirala', 'Larumbata', 'Igandea'];
    ...
    $lng['index_festivals_gm_schedule'] = 'Margolari programazioa';
    ...
    $lng['index_upcoming_activity_free'] = 'Doan';
    $lng['index_upcoming_activity_inscription'] = 'Izen ematea: ';
    $lng['index_upcoming_activity_max_people'] = 'Max. gendea: ';
    $lng['index_upcoming_activity_date'] = 'Data: ';
    $lng['index_latest_posts'] = 'Azken blog post';
    $lng['index_latest_photos'] = 'Azken argazkiak';
    $lng['index_latest_activities'] = 'Azken ekitaldiak';
    $lng['index_no_post'] = 'Ez dago blog postik.';
    $lng['index_see_all_posts'] = 'Joan blogera';
    ...
    //header.php
    $lng['header_home'] = 'Etxea';
    $lng['header_lablanca'] = 'La Blanca';
    $lng['header_activities'] = 'Ekitaldiak';
    $lng['header_blog'] = 'Blog';
    $lng['header_whoarewe'] = 'Gu';
    $lng['header_gallery'] = 'Argazkiak';
    $lng['header_press'] = 'Prentxa';
    ...
    // /blog/post.php
    $lng['blog_share'] = 'Partekatu:';
    $lng['blog_comments_0'] = 'Ez dago iruzkinik.';
    $lng['blog_comments_1'] = 'iruzki';
    $lng['blog_comments_multiple'] = 'iruzkiak';
    $lng['blog_placeholder_name'] = 'Zure izena...';
    $lng['blog_placeholder_text'] = 'Zure iruskia...';
    $lng['blog_send'] = 'Bidali';
    $lng['blog_comments_closed'] = 'Post honetan iruzkiak itxiak daude.';
    $lng['blog_'] = '';
    
    // /blog/buscar.php
    $lng['blog_search_1'] = 'Bilatzen ';
    $lng['blog_search_2'] = '  ';
    $lng['blog_search_result'] = ' emaitza.';
    $lng['blog_search_results'] = ' emaitzak.';
    ...
    // /galeria/album.php
    $lng['gallery_comment_count_0'] = "Ez dago iruzkinik";
    $lng['gallery_comment_count_1'] = "Iruzkin bat ";
    $lng['gallery_comment_count_several'] = " iruzkinak";
    $lng['gallery_new_comment'] = 'Iruzkin bat utxi ezazu.';
    $lng['gallery_new_comment_content'] = 'Testu...';
    $lng['gallery_new_comment_user'] = 'Zure izena...';
    $lng['gallery_new_comment_submit'] = 'Bidali';
    $lng['gallery_'] = '';
    
    // /galeria/upload.php
    $lng['gallery_upload_header'] = 'Argazki bat mil hitza baino gehiago balio du. <br/><br/>Gasteizko Margolariarekin argazki bat badaukazu, karga ezazu!<br/><br/>Baina kontuz: Pagina hau publikoa da. "No subas nada que no querr&iacute;as que viera tu madre". Y si en las fotos sale m&aacute;s gente, piensa tambien en sus madres.<br/><br/>¡Muchas gracias por tu colaboraci&oacute;n!';
    ...
    $lng['error_code'] = 'CODE';
    $lng['error_404_title'] = 'Ez da aurkitu';
