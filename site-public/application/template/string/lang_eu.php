<?php
    ...
    $string["yes"] = "Bai";
    $string["no"] = "Ez";
    $string["months"] = ['Urtarrila', 'Otsaila', 'Martxoa', 'Apirila', 'Maiatza', 'Ekaina', 'Uztaila', 'Abuztua', 'Iraila', 'Urria', 'Azaroa', 'Abendua'];
    $string["weekdays"] = ['Astelehena', 'Asteartea', 'Asteazkena', 'Osteguna', 'Ostirala', 'Larumbata', 'Igandea'];
    ...
    $string["section_activities"] = "Ekitaldiak";
    $string["section_lablanca"] = "La Blanca";
    $string["section_us"] = "Gu";
    $string["section_gallery"] = "Argazkiak";
    $string["section_press"] = "Prentxa";
    $string["section_join"] = "Bildu";
    $string["section_help"] = "Laguntza";

    //index.php
    $string["index_title"] = "Gasteizko Margolariak Blusa eta Neska Taldea";
    $string["index_description"] = " Gasteizko Margolariak Blusa eta Neska Taldea";
    $string["index_festivals_header"] = "Jaiak";
    $string["index_festivals_link"] = "Joan jaiak horrialdera";
    $string["index_festivals_location"] = "Hemen nago!";
    $string["index_festivals_gm_schedule"] = "Margolari programazioa";
    $string["index_festivals_city_schedule"] = "Jaiako programazioa";
    $string["index_festivals_schedule_now"] = "Orain:";
    $string["index_festivals_schedule_next"] = "Hurrengoa:";
    $string["index_upcoming_activity"] = "Hurrengo ekitaldiak";
    $string["index_upcoming_activity_see"] = "Gehiago ikusi";
    $string["index_upcoming_activity_see_all"] = "Ekitalde gustiak";
    $string["index_upcoming_activity_price"] = "Prezioa: ";
    $string["index_upcoming_activity_free"] = "Doan";
    $string["index_upcoming_activity_inscription"] = "Izen ematea: ";
    $string["index_upcoming_activity_max_people"] = "Max. gendea: ";
    $string["index_upcoming_activity_date"] = "Data: ";
    $string["index_latest_posts"] = "Azken blog post";
    $string["index_latest_photos"] = "Azken argazkiak";
    $string["index_latest_activities"] = "Azken ekitaldiak";
    $string["index_no_post"] = "Ez dago blog postik.";
    $string["index_see_all_posts"] = "Joan blogera";
    $string["index_no_photos"] = "Ez dago argazkirik";
    $string["index_see_all_photos"] = "Joan galerira";
    $string["index_read_more"] = "Gehiago irakurri";
    ...
    //header.php
    $string["header_home"] = "Etxea";
    $string["header_lablanca"] = "La Blanca";
    $string["header_activities"] = "Ekitaldiak";
    $string["header_blog"] = "Blog";
    $string["header_whoarewe"] = "Gu";
    $string["header_gallery"] = "Argazkiak";
    $string["header_press"] = "Prentxa";
    $string["header_join"] = "Bildu";

    //footer.php
    $string["footer_sponsors"] = "Kolaboratzaileak";
    $string["footer_follow"] = "Jarraitu";
    $string["footer_info"] = "Asociaci&oacute;n Cultural Recreativa Gasteizko Margolariak<br/>Errolda zk.: AS/A/17445/2013";
    $string["footer_help"] = "Laguntza";
    $string["footer_privacy"] = "Pribatutasuna";
    $string["footer_app_google"] = "App Google Play-an";
    $string["footer_app_apple"] = "App App Store-an";
    $string["cookie_message"] = "Cookiek erabili ditugu!";
    $string["cookie_ok"] = "Oso ondo";
    $string["cookie_more"] = "Esan dit gehiago!";
    $string["cookie_"] = "";

    // /lablanca/index.php
    $string["lablanca_no_title"] = "Andre Zuria Jaiak";
    $string["lablanca_description"] = "Andre Zuria Jaiei buruz informazioa";
    $string["lablanca_no_intro"] = "A la espera de Celed&oacute;n...";
    $string["lablanca_no_content"] = "Las Fiestas de La Blanca. Esos d&iacute;as, del 4 al 9 de agosto, en los que Vitoria-Gasteiz se transforma. Se llena de color y alegr&iacute;a, y en cada esquina puedes encontrar actividades y espect&aacute;culos. Todos las estamos esperando.<br/><br/>Por desgracia, a&uacute;n hay que esperar m&aacute;s.<br/>";
    ...
    $string["lablanca_title"] = "Andre Zuria Jaiak #";
    $string["lablanca_schedule"] = "Gure jaiako programazioa";
    $string["lablanca_prices"] = "Prezioak";
    $string["lablanca_prices_days"] = "Banakako egunak";
    $string["lablanca_prices_offers"] = "Packs";
    $string["lablanca_past_title"] = "Aurreko urteen kartelak";
    $string["lablanca_past_link"] = "Andre Zuria Jaiak ";
    $string["lablanca_"] = "";

    // /actividades/index.php
    $string["activities_title"] = "Ekitaldeak - Gasteizko Margolariak";
    $string["activities_descrption"] = "Asociacion Cultural Recreativa Gasteizko Margolariak - Ekitaldeak";
    $string["activities_upcoming"] = "Hurrengo ekitaldeak";
    $string["activities_no_upcoming"] = "Oraindik ez dago hurrengo ekitaterik.";
    $string["activities_past"] = "Aurreko ekitaldeak";
    $string["activities_album"] = "Argazki albuma";
    $string["activities_archive"] = "Artxiboa";
    $string["activities_date"] = "Data";
    $string["activities_city"] = "Hiria";
    $string["activities_price"] = "Prezioa";
    $string["activities_price_0"] = "Doan";
    $string["activities_maxpeople"] = "Plazak";
    $string["activities_inscription"] = "Izen ematea beharrezkoa";
    $string["activities_see_itinerary"] = "Programazioa ikusi";
    $string["activities_"] = "";


    // /actividades/actividad.php
    $string["activities_when"] = "Noiz";
    $string["activities_what"] = "Zer";
    $string["activities_where"] = "Non";
    $string["activities_"] = "";

    // /blog/index.php
    $string["blog_title"] = "Blog - Gasteizko Margolariak";
    $string["blog_descrption"] = "Asociaci&oacute;n Cultural Recreativa Gasteizko Margolariak - Blog";
    $string["blog_search"] = "Bilatu";
    $string["blog_tag_cloud"] = "Tag hodeia";
    $string["blog_archive"] = "Artxiboa";
    $string["blog_read_more"] = "Jarraitu irakurtzen";
    $string["blog_"] = "";

    // /blog/post.php
    $string["blog_share"] = "Partekatu:";
    $string["blog_comments_0"] = "Ez dago iruzkinik.";
    $string["blog_comments_1"] = "iruzki";
    $string["blog_comments_multiple"] = "iruzkiak";
    $string["blog_placeholder_name"] = "Zure izena...";
    $string["blog_placeholder_text"] = "Zure iruskia...";
    $string["blog_send"] = "Bidali";
    $string["blog_comments_closed"] = "Post honetan iruzkiak itxiak daude.";
    $string["blog_"] = "";

    // /blog/buscar.php
    $string["blog_search_1"] = "Bilatzen ";
    $string["blog_search_2"] = "  ";
    $string["blog_search_result"] = " emaitza.";
    $string["blog_search_results"] = " emaitzak.";

    // /nosotros/index.php
    $string["us_title"] = "Gu - Gasteizko Margolariak";
    $string["us_description"] = "Asociaci&oacute;n Cultural Gasteizko Margolariak";
    ...
    $string["us_association"] = "Asoziazioia";
    ...
    $string["us_activities"] = "Edin dugula";
    ...
    $string["us_transparency"] = "Gardentasuna";
    ...
    // /galeria/index.php
    $string["gallery_title"] = "Galera";
    $string["gallery_description"] = "Gasteizko Margolarien argazkiak";
    $string["gallery_header"] = "Argazki bat mil hitza baino gehiago balio du. <br/><br/>Laguntza eman diguzu? <a href="http://' . $http_host . '/galeria/upload/">Zure argazkiak kargatu</a> ahal duzu!";
    $string["gallery_albums"] = "Albums";
    $string["gallery_photos_singular"] = "argazkia";
    $string["gallery_photos_plural"] = "argazkiak";
    $string["gallery_read_more"] = "Gehiago irakurri";
    $string["gallery_user"] = "Arabera: ";
    $string["gallery_"] = "";

    // /galeria/album.php
    $string["gallery_comment_count_0"] = "Ez dago iruzkinik";
    $string["gallery_comment_count_1"] = "Iruzkin bat ";
    $string["gallery_comment_count_several"] = " iruzkinak";
    $string["gallery_new_comment"] = "Iruzkin bat utxi ezazu.";
    $string["gallery_new_comment_content"] = "Testu...";
    $string["gallery_new_comment_user"] = "Zure izena...";
    $string["gallery_new_comment_submit"] = "Bidali";
    $string["gallery_"] = "";

    // /galeria/upload.php
    $string["gallery_upload_header"] = "Argazki bat mil hitza baino gehiago balio du. <br/><br/>Gasteizko Margolariarekin argazki bat badaukazu, karga ezazu!<br/><br/>Baina kontuz: Pagina hau publikoa da. "No subas nada que no querr&iacute;as que viera tu madre". Y si en las fotos sale m&aacute;s gente, piensa tambien en sus madres.<br/><br/>¡Muchas gracias por tu colaboraci&oacute;n!";
    $string["gallery_upload_select_album"] = "--Selecciona un album--";
    $string["gallery_upload_submit"] = "Subir fotos";
    $string["gallery_upload_placeholder_title"] = "Titulo (opcional)";
    ...
    $string["gallery_upload_tooltip_album"] = "Elije el album m&aacute;s apropiado para tus fotos.";
